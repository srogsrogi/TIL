...
- 내용이 굉장히 많고, 개념들 간의 관계를 한 번에 파악하기 어려울 수 있습니다. 핵심 키워드 위주로 복습하시고, 실제 모델을 활용하여 개발하는 과정 중에도 한 번씩 관련 개념들을 살펴 가며 머릿속에 통합된 하나의 흐름을 만들어 내시길 바랍니다.
- 내용이 많다고는 했지만.. 이 정도는 알아야 다음 단계로 넘어가 주요 모델별 메커니즘이나 특징, 활용법 등을 이해하고 학습할 수 있습니다! 시간을 충분히 들여 넓게 이해하고 그걸 기반으로 SSAFY 정규 강의도 더 깊이 이해해봅시다.
