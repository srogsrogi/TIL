...
- 수강생 1
  ...
  이번 수업에서는 DNS와 SSL의 개념부터 실제 도메인 연결까지 전 과정을 직접 경험할 수 있었습니다. 단순히 개념으로만 알고 있던 A record, CNAME, SSL 인증서 등의 개념을 실습을 통해 확실히 이해할 수 있었습니다. 특히 직접 도메인을 구매하고 서버에 연결하면서, 브라우저에서 도메인을 입력했을 때 요청이 어떻게 서버로 전달되는지 확인할 수 있었던 점이 이해하는데 큰 도움이 되었습니다. 
